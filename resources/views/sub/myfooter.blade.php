            ...
            <div class="info">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 text-center">
                        <a href="#" target="_blank"><img src="{{asset('public/assets/img/bazzar.png')}}" width="159" height="48"
                                                         alt=""></a>
                        <a href="#" target="_blank"><img src="{{asset('public/assets/img/sibapp.png')}}" width="159" height="48"
                                                         alt=""></a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="symbol col-12 col-lg-5">
                        ...
                        <a href="#" target="_blank"><img src="{{asset('public/assets/img/symbol-02.png')}}" alt=""></a>
                    </div>
                    <div class="col-12">
                        <div class="row">
