...
<head>
    ...
    <base href="{{url('public/admin')}}/" target="_blank">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active treeview">
                    <a href="#">
                        <i class="fa fa-shopping-basket"></i> <span>فروش</span>
                        <span class="pull-left-container">
                <i class="fa fa-angle-right pull-left"></i>
              </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="index.html"><i class="fa fa-list"></i> سفارش ها</a></li>
                        <li><a href="index2.html"><i class="fa fa-user"></i>  مشتریان</a></li>
                        <li><a href="index2.html"><i class="fa fa-user"></i>  خدمات مشتریان</a></li>
                        <li><a href="index2.html"><i class="fa fa-area-chart"></i>آمار</a></li>
                    </ul>
                </li>
                ...
                <i class="fa fa-angle-right pull-left"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-plus-circle"></i> افزودن دسته</a></li>
