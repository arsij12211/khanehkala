                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="product-gallery default">
                                            <img class="zoom-img" id="img-product-zoom" src="{{asset('public/assets/img/product/1335154.jpg')}}"
                                                data-zoom-image="{{asset('public/assets/img/product/13351544.jpg')}}" width="411" />
                                                ...
                                                <ul class="gallery-items owl-carousel owl-theme" id="gallery-slider">
                                                    <li class="item">
                                                        <a href="#" class="elevatezoom-gallery active" data-update=""
                                                            ...
                                                            <img src="{{asset('public/assets/img/product/2114766.jpg')}}" width="100" /></a>
                                                    </li>
                                                    <li class="item">
                                                        <a href="tester" class="elevatezoom-gallery"
                                                            ...
                                                            <img src="{{asset('public/assets/img/product/1335154.jpg')}}" width="100" />
                                                        </a>
                                                    </li>
                                                    <li class="item">
                                                        <a href="#" class="elevatezoom-gallery"
                                                            ...
                                                            data-zoom-image="{{asset('public/assets/img/product/3694075.jpg')}}"><img
                                                                src="{{asset('public/assets/img/product/3694075.jpg')}}" width="100" /></a>
                                                    </li>
                                                    <li class="item">
                                                        <a href="tester" class="elevatezoom-gallery"
                                                            data-image="{{asset('public/assets/img/product/1335154.jpg')}}"
                                                    ...
                                                    <li class="item">
                                                        <a href="tester" class="elevatezoom-gallery"
                                                            ...
                                                            class="slide-content"><img
                                                                src="{{asset('public/assets/img/product/110197298.jpg')}}" height="68" /></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                                ...
                                                                <li>
                                                                    <div class="comment-body">
                                                                        <div class="comment-author">
                                                                            <img alt="" src="{{asset('assets/img/default-avatar.png')}}"
...
@section('js')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".cart-product-quantity").append('<div class="inc buttonNumber">+</div><div class="dec buttonNumber">-</div>');
            ...
            $(".buttonNumber").on("click", function () {
                ...
                var inptNumber = $button.parent().find("input");
                // .val(newVal);
                inptNumber.attr('value', newVal);

            });

            // end of number of product


            $('#addProductToCart').on('click', function (e) {
                e.preventDefault();
                var colorId = $('#soflow-color').find(':selected').val();
                var product_id = $(this).attr('data-Id')
                var url = '/isan3/isan/pan/addCart/' + product_id + '/' + colorId;
                if (!isNaN(colorId)) {
                    $.ajax({
                        type: "GET",
                        url: url,
                    ...
                    swal("توجه", "ابتدا رنگ محصول را انتخاب نمایید.", "warning");
                }
            ...
            //         var colorId = $('#soflow-color').find(':selected').val();
            //
            //         if (Number.isInteger(parseInt(colorId)) === false) {
            //             swal("", "لطفا رنگ کالای مورد نظر خود را انتخاب نمایید.", "info");
            //             return;
            //         }
            //         var product_id = $(this).attr('data-Id')
            //         var url = '/isan3/isan/pan/addCart/' + product_id + '/' + colorId;
            ...
            $("#storeComment").on('click', function () {
                $("#storeCommentForm").on('submit', function (e) {
                    e.preventDefault();
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            // console.table(data);
                            if (data.status == 1) {
                                swal("موفقیت آمیز", data.msg, "success");
                            } else {
            ...
            $('#addFavorit').on('click', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        // console.table(data);
                        if (data.status == 1) {         //  inserted
                            $('#addFavorit').css('color', '#6D3392');
                        } else if (data.status == -1) {    //  deleted
                            $('#addFavorit').css({
                                'color': '#ffffff'
                            });
                            // $('#favorite' + data.favId).hover(function () {
                            //     $('#favorite' + data.favId).css('color', 'red');
                            // }, function () {
                            //     $('#favorite' + data.favId).css('color', 'transparent');
                            // });
                        } else {    //  data.status = 0
                            swal("خطا", "ثبت این کالا به عنوان علاقه مندی با خطا همراه شد.", "error");
                        }
