        ...
        <aside class="sidebar col-12 col-lg-3 order-2 order-lg-1">
            <div class="sidebar-inner default">
                <div class="widget-banner widget card">
                    <a href="#" target="_top">
                        <img class="img-fluid" src="{{asset('public/assets/img/banner/1455.jpg')}}" alt="">
                    </a>
                </div>
                ...
                <div class="widget-suggestion widget card">
                    ...
                    <div id="suggestion-slider" class="owl-carousel owl-theme">
                        <div class="item">
                            <a href="#">
                                <img src="{{asset('public/assets/img/product/692674-200x200.jpg')}}" class="w-100" alt="">
                            </a>
                        ...
                        <div class="item">
                            <a href="#">
                                <img src="{{asset('public/assets/img/product/e75a73-200x200.jpg')}}" class="w-100" alt="">
                            </a>
                            <h3 class="product-title">
                        ...
                        <div class="item">
                            <a href="#">
                                <img src="{{asset('public/assets/img/product/482250-200x200.jpg')}}" class="w-100" alt="">
                            </a>
                            <h3 class="product-title">
                        ...
                        <div class="item">
                            <a href="#">
                                <img src="{{asset('public/assets/img/product/19a2cc-200x200.jpg')}}" class="w-100" alt="">
                            </a>
                            <h3 class="product-title">
                ...
                <div class="widget-banner widget card">
                    <a href="#" target="_blank">
                        <img class="img-fluid" src="{{asset('public/assets/img/banner/1000001422.jpg')}}" alt="">
                    </a>
                </div>
                <div class="widget-banner widget card">
                    <a href="#" target="_blank">
                        <img class="img-fluid" src="{{asset('public/assets/img/banner/side-banner-01.jpeg')}}" alt="">
                    </a>
                </div>
                <div class="widget-banner widget card">
                    <a href="#" target="_top">
                        <img class="img-fluid" src="{{asset('public/assets/img/banner/1000001322.jpg')}}" alt="">
                    </a>
                </div>
                <div class="widget-banner widget card">
                    <a href="#" target="_blank">
                        <img class="img-fluid" src="{{asset('public/assets/img/banner/1000001442.jpg')}}" alt="">
                    </a>
                </div>
                <div class="widget-banner widget card">
                    <a href="#" target="_blank">
                        <img class="img-fluid"
                             src="{{asset('public/assets/img/banner/8d546388-29d7-4733-871f-2d84a3012cc227_21_1_6.jpeg')}}"
                             alt="">
                    </a>
                </div>
                <div class="widget-banner widget card">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <a class="d-block" href="#">
                            <img src="{{asset('public/assets/img/slider/22f48d8e-6a8f-431c-985d-76ab0e1e59405_21_1_1.jpg')}}"
                                 class="d-block w-100" alt="">
                        </a>
                    </div>
                    <div class="carousel-item">
                        <a class="d-block" href="#">
                            <img src="{{asset('public/assets/img/slider/a264d696-9c12-4dd9-bdc1-12c13a3632b329_21_1_1.jpg')}}"
                                 class="d-block w-100" alt="">
                        </a>
                    </div>
                    <div class="carousel-item">
                        <a class="d-block" href="#">
                            <img src="{{asset('public/assets/img/slider/c0a50594-df40-412b-84f8-c7d6872fb83620_21_1_1.jpg')}}"
                                 class="d-block w-100" alt="">
                        </a>
                    </div>
                    <div class="carousel-item">
                        <a class="d-block" href="#">
                            <img src="{{asset('public/assets/img/slider/d1844e92-e5a9-4aef-8ea7-49be936422ca6_21_1_1.jpg')}}"
                                 class="d-block w-100" alt="">
                        </a>
                    </div>
                </div>
            ...
            <section id="amazing-slider" class="carousel slide carousel-fade card" data-ride="carousel">
                <div class="row m-0">
                    ...
                    <div class="carousel-inner p-0 col-12 col-lg-9">
                        <img class="amazing-title" src="{{asset('public/assets/img/amazing-slider/amazing-title-01.png')}}"
                             alt="">
                        <div class="carousel-item active">
                            <div class="row m-0">
                                <div class="right-col col-5 d-flex align-items-center">
                                    <a class="w-100 text-center" href="#">
                                        <img src="{{asset('public/assets/img/amazing-slider/60eb20-200x200.jpg')}}"
                                             class="img-fluid" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="carousel-item">
                            <div class="row m-0">
                                <div class="right-col col-5 d-flex align-items-center">
                                    <a class="w-100 text-center" href="#">
                                        <img src="{{asset('public/assets/img/amazing-slider/4ff777-200x200.jpg')}}"
                                             class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="left-col col-7">
                        ...
                        <div class="carousel-item">
                            <div class="row m-0">
                                <div class="right-col col-5 d-flex align-items-center">
                                    <a class="w-100 text-center" href="#">
                                        <img src="{{asset('public/assets/img/amazing-slider/35a2b8-200x200.jpg')}}"
                                             class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="left-col col-7">
                        ...
                        <div class="carousel-item  finished">
                            <div class="row m-0">
                                <div class="right-col col-5 d-flex align-items-center">
                                    <a class="w-100 text-center" href="#">
                                        <img src="{{asset('public/assets/img/amazing-slider/c8297f-200x200.jpg')}}"
                                             class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="left-col col-7">
                        ...
                        <div class="carousel-item  finished">
                            <div class="row m-0">
                                <div class="right-col col-5 d-flex align-items-center">
                                    <a class="w-100 text-center" href="#">
                                        <img src="{{asset('public/assets/img/amazing-slider/36855a-200x200.jpg')}}"
                                             class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="left-col col-7">
                        ...
                        <div class="carousel-item">
                            <div class="row m-0">
                                <div class="right-col col-5 d-flex align-items-center">
                                    <a class="w-100 text-center" href="#">
                                        <img src="{{asset('public/assets/img/amazing-slider/0e6809-200x200.jpg')}}"
                                             class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="left-col col-7">
                        ...
                        <div class="carousel-item  finished">
                            <div class="row m-0">
                                <div class="right-col col-5 d-flex align-items-center">
                                    <a class="w-100 text-center" href="#">
                                        <img src="{{asset('public/assets/img/amazing-slider/2d71f4-200x200.jpg')}}"
                                             class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="left-col col-7">
                        ...
                        <div class="carousel-item">
                            <div class="row m-0">
                                <div class="right-col col-5 d-flex align-items-center">
                                    <a class="w-100 text-center" href="#">
                                        <img src="{{asset('public/assets/img/amazing-slider/59fc05-200x200.jpg')}}"
                                             class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="left-col col-7">
                        ...
                        <div class="carousel-item">
                            <div class="row m-0">
                                <div class="right-col col-5 d-flex align-items-center">
                                    <a class="w-100 text-center" href="#">
                                        <img src="{{asset('public/assets/img/amazing-slider/8eb96c-200x200.jpg')}}"
                                             class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="left-col col-7">
            ...
            <div class="row" id="amazing-slider-responsive">
                <div class="col-12">
                    <div class="widget widget-product card">
                        <header class="card-header">
                            <img src="{{asset('public/assets/img/amazing-slider/amazing-title-01.png')}}" width="150px" alt="">
                            <a href="#" class="view-all">مشاهده همه</a>
                        </header>
                        <div class="product-carousel owl-carousel owl-theme">
                            <div class="item">
                                <a href="#">
                                    <img src="{{asset('public/assets/img/product-slider/60eb20-200x200.jpg')}}"
                                         class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                                    <a href="#">لپ تاپ ۱۱٫۶ اینچی دل مدل INSPIRON 3168 -AC B</a>
                            ...
                            <div class="item">
                                <a href="#">
                                    <img src="{{asset('public/assets/img/product-slider/4ff777-200x200.jpg')}}"
                                         class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                                    <a href="#">لپ تاپ ۱۴ اینچی دل مدل vostro 5471</a>
                            ...
                            <div class="item">
                                <a href="#">
                                    <img src="{{asset('public/assets/img/product-slider/35a2b8-200x200.jpg')}}"
                                         class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                                    <a href="#">لپ تاپ ۱۵ اینچی دل مدل Latitude 5580</a>
                            ...
                            <div class="item">
                                <a href="#">
                                    <img src="{{asset('public/assets/img/product-slider/9b3da9-200x200.jpg')}}"
                                         class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                            ...
                            <div class="item">
                                <a href="#">
                                    <img src="{{asset('public/assets/img/product-slider/c8297f-200x200.jpg')}}"
                                         class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                                    <a href="#">لپ تاپ ۱۵ اینچی دل مدل INSPIRON 7577 - D</a>
                            ...
                            <div class="item">
                                <a href="#">
                                    <img src="{{asset('public/assets/img/product-slider/a579bb-200x200.jpg')}}"
                                         class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                            ...
                            <div class="item">
                                <a href="#">
                                    <img src="{{asset('public/assets/img/product-slider/19a2cc-200x200.jpg')}}"
                                         class="img-fluid" alt="">
                                </a>
                                <h2 class="post-title">
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="widget-banner card">
                                <a href="#" target="_blank">
                                    <img class="img-fluid" src="{{asset('public/assets/img/banner/banner-9.jpg')}}" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="widget-banner card">
                                <a href="#" target="_top">
                                    <img class="img-fluid" src="{{asset('public/assets/img/banner/banner-10.jpg')}}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="widget widget-banner card">
                                <a href="#" target="_blank">
                                    <img class="img-fluid" src="{{asset('public/assets/img/banner/banner-11.jpg')}}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
